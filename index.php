                    ...
                    <div class="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col md:flex-row gap-4 justify-between items-center sticky top-0 z-20">
                        ...
                        <div class="flex w-full md:w-auto gap-3">
                            <div class="relative flex-1 md:w-64">
                                ...
                                <input type="text" placeholder="Rechercher..." class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-zoo-500 focus:border-transparent transition-all">
                            </div>
                            
                            <select id="filter-habitat" onchange="filterAnimals()" class="px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-600 focus:outline-none focus:ring-2 focus:ring-zoo-500 cursor-pointer">
